...
namespace library.Data.Migrations
{
    ...
    [Migration("20240307121410_AddRentalsCopeisTable")]
    partial class AddRentalsCopeisTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("library.Data.Models.Area", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library.Data.Models.BookCopy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library.Data.Models.Governorate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library.Data.Models.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library.Data.Models.RentalCopy", b =>
                {
            ...
            modelBuilder.Entity("library.Data.Models.Subscriber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library.Data.Models.Area", b =>
                {
                    b.HasOne("library.Data.Models.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("library.Data.Models.Governorate", "Governorate")
                        .WithMany("Areas")
                        .HasForeignKey("GovernorateId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("library.Data.Models.ApplicationUser", "LastUpdatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("library.Data.Models.Rental", b =>
                {
                    ...
                    b.HasOne("library.Data.Models.Subscriber", "Subscriber")
                        .WithMany("Rentals")
            ...
            modelBuilder.Entity("library.Data.Models.RentalCopy", b =>
                {
                    b.HasOne("library.Data.Models.BookCopy", "BookCopy")
                        .WithMany()
                        .HasForeignKey("BookCopyId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("library.Data.Models.Rental", "Rental")
            ...
            modelBuilder.Entity("library.Data.Models.Subscriber", b =>
                {
                    b.HasOne("library.Data.Models.Area", "Area")
                        .WithMany()
